...
export default function TypeStep({ category, supertype, onChangeCategory, onChangeSupertype }) {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Physical or digital?</p>
          ...
          {SUPERTYPES.map((s) => {
            ...
            return (
              <button
                ...
                className={clsx(TILE_BASE, supertype === s.value ? TILE_ACTIVE : TILE_INACTIVE)}
              >
                <Icon size={22} />
                {s.label}
              </button>

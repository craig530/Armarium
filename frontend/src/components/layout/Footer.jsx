  ...
  return (
    <footer className="mx-auto max-w-7xl px-4 py-6 mt-8 border-t border-gray-200 dark:border-gray-800 text-xs text-gray-400 dark:text-gray-500 space-y-1">
      <p>
        ...
        <a href="https://armarium.app" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-gray-600 dark:hover:text-gray-300">
          Armarium
        </a>{' '}
        contributors. Open source software, MIT licence.
      </p>
      <p>
